...
void Biome::initBiomes() {
	rainForest		= (new RainforestBiome())->setColor(0x08FA36)->setName("Rainforest")->setLeafColor(0x30E060);
	swampland		= (new SwampBiome())->setColor(0x07F9B2)->setName("Swampland")->setLeafColor(0x6A7F39);
	seasonalForest	= (new Biome())->setColor(0x9BE023)->setName("Seasonal Forest");
	forest			= (new ForestBiome())->setColor(0x056621)->setName("Forest")->setLeafColor(0x4EC532);
